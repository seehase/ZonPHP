...
<div id="page-content">
    ...
    <div id='jqxwindow_cumulative_overview' class="smallCharts"
         style="<?= WINDOW_STYLE ?> <?php if (!isset($charts['chart_allyearoverview'])) echo ' display: none;'; ?> ">
        <a href="cumulative_overview.php">
            <div class="<?= HEADER_CLASS ?>"><?php echo $txt['chart_cumulativeoverview'] ?> </div>
        </a>
        <div id='cumulative_chart_id' class="<?= CONTENT_CLASS ?>" style="<?= CHART_STYLE ?>"></div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#jqxwindow_cumulative_overview").jqxPanel({height: 410, width: 440, theme: 'zonphp'});
...
" ?>
            ...
            <?php echo "            
            var container_cumulative = $('#cumulative_chart_id');
            $.ajax({
                ...
                cache: false,
                success: function (chart) {
                    $(container_cumulative).append(chart);
                },
                error: function (xhr, desc, err) {
                    console.log(xhr + '\\n' + err);
                }
