...
if (isset($param['show_menu']))
{
    $show_menu = "clear:both; ";
}
?>
<input type="checkbox" name="nav" id="main-nav-check"/>
<div id="menu" style="<?php echo $show_menu; ?>">
    ...
    <ul>
        <li><a href="#" style="display: flex">&nbsp;</a> <label for="fof" class="toggle-sub" onclick="">
            ...
            <ul id="fof-sub" class="sub-nav">
                <li class="sub-heading"><?php echo $txt["grafiekoverzicht"]; ?><label for="fof" class="toggle" onclick="" title="Back">&#9658;</label></li>
        ...
        <li><a href="#" style="display: flex">&nbsp;</a> <label for="info" class="toggle-sub" onclick=""><span style="text-align: right">&nbsp;Info&nbsp;&nbsp;&nbsp;&#9658;</span></label>
            ...
            <ul id="info-sub" class="sub-nav">
                <li class="sub-heading"><?= $version ?><label for="info" class="toggle" onclick="" title="Back">&#9658;</label></li>
