...
<div id="container" >	
	<div id="bodytext">
		<div class="inside">
			<font size="-1">Dit script leest het bestand Invullen_aangepaste_gegevens.txt en past waar nodig de aanpassingen toe aan te database.<br /><br />
				In dat bestand kan je manuele gegevens invullen, handig wanneer er ontbrekende of onvolledige databestanden zijn.
				...
				if ($teller>2){
					if(!empty($geg)){
						...
						if($iverkeerd==0){
							...
							echo $TimeStamp;echo "=";echo $kWh;echo "=";echo "$Naam"; echo"<br />";
